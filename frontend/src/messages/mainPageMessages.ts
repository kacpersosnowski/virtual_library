...
const mainPageMessages: Message = {
  searchPlaceholder: {
    key: "main_page >> search >> placeholder",
    pl: "Szukaj",
    en: "Search",
  },
  bannerHeader: {
  ...
  buttonsRegister: {
    key: "main_page >> buttons >> register",
    pl: "Zarejestruj się",
    en: "Register",
  },
  buttonsJoinUs: {
    key: "main_page >> buttons >> join_us",
    pl: "Dołącz do nas",
    en: "Join us",
  },
  booksListHeader: {
  ...
  buttonsSeeMore: {
    key: "main_page >> buttons >> see_more",
    pl: "Zobacz więcej",
    en: "See more",
  },
  footer: {
    key: "main_page >> footer",
