...
public class BookTestDataBuilder {
    ...
    public static BookExample bookExample() {
        ...
        Book book = Book.builder()
                .id(bookId)
                .title("exampleTitle")
                .authorIdList(List.of(AuthorTestDataBuilder.authorExample().author().getId()))
                .description("exampleDescription")
                .genreIdList(List.of(GenreTestDataBuilder.genreExample().genre().getId()))
    ...
    public static BookDtoExample bookDtoExample() {
        ...
        BookDto bookDto = BookDto.builder()
                ...
                .description("exampleDescription")
                .genreList(List.of(GenreTestDataBuilder.genreDtoExample().genreDto()))
                .tagList(List.of("exampleTag", "exampleTag2"))
                .language(Language.PL)
                .bookCoverId(null)
                .bookContentId(null)
